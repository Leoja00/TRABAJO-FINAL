...
<div class="relative w-full min-h-screen bg-fixed bg-cover bg-center"
    ...
    <div class="relative flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 overflow-x-hidden">
    <div class="relative bg-clip-border rounded-xl bg-white bg-opacity-80 text-gray-700 shadow-md w-full max-w-7xl flex flex-col lg:flex-row mt-32 sm:mt-128 md:mt-40">

            
            <div id="perfil"
                class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-0 sm:mx-2 md:mx-6 lg:mx-0">
                ...
                <div class="p-4 md:p-8 text-center lg:text-left">
                    ...
                    <!-- Avatar para pantallas pequeñas -->
                    @if (Auth::user()->role === 'profesional' && Auth::user()->profesional->imagen)
                    <img src="{{ asset(Auth::user()->profesional->imagen) }}" alt="Avatar de {{ Auth::user()->name }}"
                    class="w-40 h-40 rounded-full mx-auto mb-4 lg:hidden max-w-full h-auto">
                    @endif
                    ...
                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" class="h-8 w-8 text-green-500 mr-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15 9h3.75M15 12h3.75M15 15h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
                        </svg>
            ...
            <div class="w-full lg:w-2/5">
                ...
                @if ($image)
                <img src="{{ asset($image) }}" alt="Imagen de {{ Auth::user()->name }}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block max-w-full h-auto">
                @else
