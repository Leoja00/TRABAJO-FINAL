...
<div class="relative w-full min-h-screen bg-fixed bg-cover bg-center" style="background-image: url('medico.jpeg');">
    ...
    <div class="relative z-10 w-full px-4 py-8">
        <div class="flex flex-wrap justify-center gap-8 mt-32">
            ...
            <div
                class="relative flex flex-col text-black bg-white bg-opacity-65 shadow-md bg-clip-border rounded-xl w-full sm:w-80 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                <div
                    class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-opacity-90 shadow-lg bg-clip-border rounded-xl h-80">
                    <img src="{{ asset($profesional->imagen) }}"
                        alt="Imagen de perfil de {{ $profesional->user->name }}" class="w-full h-full object-cover" />

                </div>
                <div class="p-6 text-center">
                    <h4
                        class="block mb-2 font-sans text-2xl antialiased font-bold leading-snug tracking-normal text-blue-gray-900">
